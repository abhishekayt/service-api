...
import { Coins, KeyRound, LayoutDashboard, ScrollText, Sparkles, Terminal, ChevronRight } from "lucide-react";
...
export default function UserSidebar() {
    ...
    return (
        <aside className="flex h-full min-h-[calc(100vh-2rem)] flex-col justify-between rounded-2xl border border-slate-200/80 bg-white/80 p-4 shadow-sm backdrop-blur-xl dark:border-slate-800/80 dark:bg-slate-900/90 text-slate-800 dark:text-slate-100">
            <div>
                {/* Brand Logo & Application Title */}
                <Link
                    href="/user/dashboard"
                    onClick={closeMobileSidebar}
                    className="flex items-center gap-3 px-2 py-2 transition-opacity hover:opacity-90"
                >
